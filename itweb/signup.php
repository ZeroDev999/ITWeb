...
<body style="background: linear-gradient(to right,rgb(0, 0, 0),rgb(255, 0, 0),rgb(0, 0, 0));">
    ...
    <div class="container d-flex justify-content-center align-items-center" style="height: 100vh; max-width: 900px;">
        <div class="card" style="width: 100%;">
            <div class="row g-0">
                ...
                <div class="col-md-6">
                    <img src="assets/imgs/R.gif" class="img-fluid" style="object-fit: cover; width: 100%; height: 100%"
                        alt="Robux gif">
                </div>
            </div>
        </div>
